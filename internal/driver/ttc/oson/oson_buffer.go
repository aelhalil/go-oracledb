...
func newOsonBuffer(buf drvCommon.B1Array) *osonBuffer {
...
func (b *osonBuffer) readSlice(length int) (drvCommon.B1Array, error) {
...
func (b *osonBuffer) readUB1() (drvCommon.UB1, error) {
	value, err := b.readUint8()
	return drvCommon.UB1(value), err
}

// readUB2 reads an unsigned 2-byte big-endian OSON value.
func (b *osonBuffer) readUB2() (drvCommon.UB2, error) {
	value, err := b.readUint16()
	return drvCommon.UB2(value), err
}

// readUB4 reads an unsigned 4-byte big-endian OSON value.
func (b *osonBuffer) readUB4() (drvCommon.UB4, error) {
