...
func isCompactSigned64Opcode(opcode drvCommon.UB1) bool {
...
func isCompactOracleNumberOpcode(opcode drvCommon.UB1) bool {
...
func isCompactDecimalOpcode(opcode drvCommon.UB1) bool {
